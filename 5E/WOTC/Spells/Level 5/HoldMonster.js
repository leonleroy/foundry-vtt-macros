...
if (args[0].failedSaves.length > 0) {
    ...
    for (let target of targets) {
		...
		if ((find_target.actor.type === "npc") && ((find_target.actor.system.details.type.value.toLowerCase() === "humanoid") || ( (find_target.actor.system.details.type.value.toLowerCase() === "undead")) )) {
		console.log("Skipping humanoid or undead NPC: ",  find_target.actor.name);
		continue;
		}
